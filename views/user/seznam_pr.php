                                    ...
                                    <section class="login">
                                        ...
                                        <table class="tg_user">
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="Nazev">NAZEV</td>
                                                <td data-label="Autori">AUTOR</td>
                                                <td data-label="Vymazat"><a href="?delete=$row[post_id]"><i
                                                                class="fa fa-times" aria-hidden="true"></i> Vymazat</a>
                                                </td>
                                                <td data-label="Editovat"><a href="?edit=$row[post_id]"><i
